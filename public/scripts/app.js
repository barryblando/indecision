...
var IndecisionApp = function (_React$Component) {
  ...
  function IndecisionApp(props) {
    ...
    _this.handlePick = _this.handlePick.bind(_this); // bind to the current instance
    _this.handleAddOption = _this.handleAddOption.bind(_this); // bind to the current instance
    _this.handleDeleteOption = _this.handleDeleteOption.bind(_this); // bind to the current instance
    _this.state = {
      options: []
    };
    return _this;
...
var AddOption = function (_React$Component2) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(e) {
      ...
      var option = e.target.elements.option.value.trim(); // input name option & value, and trim white spaces
